  ...
  return (
    <div className="mx-auto max-w-[1000px] px-8 py-7">
      ...
      <div className="overflow-hidden rounded-xl border border-border bg-card">
        {!calls && <div className="p-6 text-sm text-muted-foreground">Loading…</div>}
        {calls && calls.length === 0 && <div className="p-10 text-center text-sm text-muted-foreground">No calls recorded yet.</div>}
        {calls?.map((c, i) => (
